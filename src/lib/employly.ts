...
export const SEED: Profile[] = [
  {
    ...
    skills: ["Crochet", "Knitting", "Teaching"],
  ...
  },
  {
    ...
    skills: ["Social media", "Flyer/Poster making", "Drawing"],
  ...
  },
  {
    ...
    name: "Noor Imran",
    location: "Olaya District",
    skills: ["Flyer/Poster Making", "Social media"],
  ...
  },
  {
    ...
    name: "Zikra's Bakery",
    location: "Sulaimaniyah",
    skills: ["Knitting", "Cooking", "Social media"],
  ...
  },
  {
    ...
    location: "\n",
    skills: ["Drawing", "Painting", "Flyer/Poster making"],
